module.exports =
  ...
  guide:
    ...
    intro_VICS82_text_5: "Previously on Space Warps we were investigating images taken in the  optical part of the spectrum as part of the CFHT Legacy Survey (CFHTLS), where nearby massive galaxies look yellow, and star-forming galaxies in the background look blue. We were also doing a &quot;blind&quot; search, where there was not a target in the center of each image - and the images had larger fields of view, about 70 arcsec compared to the 40 arcsec of VICS82. Finally, the CFHTLS images are &quot;deeper&quot; (the exposure times were longer), so more galaxies can be seen in any given area than in VICS82. The consequence of this is that lenses will be harder to spot in VICS82!"
    intro_VICS82_text_6: "Gravitational lensing works in the infrared the same way as it does in the optical: this means that we should see the same characteristic patterns of arcs, counter-arcs, rings and multiple image systems in the VICS82 images as we did in the CFHTLS ones, its just the colours will be a bit different."
