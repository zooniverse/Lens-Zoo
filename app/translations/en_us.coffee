module.exports =
  ...
  tutorial:
    ...
    what_are_lenses_2:
      ...
      details: "Gravitational lenses, such as massive galaxies or groups of galaxies, make regular patterns around themselves, as multiple &quot;images&quot; of the faint background source are formed."
    spotters_guide:
      header: "Spotter's Guide"
      details: "Check out The Spotter's Guide  for detailed descriptions and reference images of objects that really are lenses, and objects that look a lot like them.  You can use the Spotter's Guide as a reference throughout your time on Space Warps."
    identify:
    ...
    training:
      ...
      details: "From time to time we'll throw in a training image like this one, that contains a simulated gravitational lens. Watch out! Some of them are quite hard to see... We'll let you know if you spot the lenses in training images, so you can improve your skills."
    ...
    thanks:
      header: "Thanks!"
      details: "Remember: lensed galaxies are rare, and difficult to spot: relatively few of the images you will see will contain a gravitational lens, and you may need to look quite carefully to see the lensed features! You can keep track of the expected lens frequency as you go at the top of this page.<br/><br/>Over your first few classifications we'll give you a few more tips and access to some different tools to help you as you search for these rare objects.<br/><br/>Click 'Finished marking!' to continue."
    ...
    dashboard:
      ...
      details: "As gravitationally lensed features can be faint, small, and blended with other objects, you can explore an image in more detail in the Quick Dashboard. Try clicking on this button."
  ...
  feedback:
    ...
    details:
      lensing_cluster:
        ...
        option_4: "If you see an arc, look for a &quot;counter-image&quot; with the about the same color and brightness somewhere else around the centre of the group, usually on the opposite side. The <em>Quick Dashboard</em> can sometimes help you find them."
        option_5: "Remember, the arcs are most likely to be blue or greenish, but they can be yellow or red in some cases. Multiple &quot;images&quot; of the same background galaxy are always the same color as each other!"
        ...
        option_7: "Faint arcs in groups can be hard to spot. You can see more examples in the <em>Spotters Guide</em>."
      lensed_quasar:
        ...
        option_2: "See how the &quot;multiple images&quot; of the background quasar are arranged in symmetrical patterns around the lens galaxy. Mark each one! You might have to zoom in, using the <em>Quick Dashboard</em>."
        ...
        option_6: "Faint lensed quasars can be hard to spot. You can see more examples in the <em>Spotters Guide</em>."
      lensed_galaxy:
        ...
        option_4: "Look for a faint &quot;counter-image&quot; with the same colour on the opposite side of the lens to the arc. Sometimes these are too faint to see though."
        ...
        option_7: "Faint arcs around galaxies are the hardest lens systems to spot. You can see more examples in the <em>Spotters Guide</em>."
      missed:
    ...
    dud_missed:
      ...
      details: "This is a different kind of Training Image, one that has already been inspected by the Science Team and found not to contain any gravitational lenses. Check out the Spotter's Guide for more examples of things that are not lenses."
    false_positives:
  ...
  about:
    ...
    CFHTLSreboot: "Testing our Analysis"
    CFHTLSreboot_text: "We're actually in between surveys right now, which gives us a chance to improve the analysis of your classifications. After experimenting with our pipeline a bit using the first set of classifications you made on the CFHTLS images, we've carried out a re-analysis and come up with some interesting new candidates that we think are worth a second look. These are the images that are currently in the site, along with the same set of training images (simulated lenses, and images that we know don't contain lenses). Let's see if we can find even more lenses this second time around!"

    intro: "Meet the Space Warps science and development teams below - and then look out for them on Space Warps Talk! You can also follow along as they write research papers based on your classifications, at <a href='https://github.com/drphilmarshall/SpaceWarps/'>the Space Warps GitHub repository</a>."
    ...
    paget_bio: "Ed Paget joined Adler's Zooniverse team as a software developer in August 2012. He previously worked as a freelance programmer and photographer. Ed graduated from Northwestern University with a major in Radio/TV/Film."
    snyder_bio: "Chris Snyder is a web developer, working on the Zooniverse series of projects in Chicago. Born in Philadelphia, he learned to use computers at a young age. He received a degree in computer science from the University of Dayton in 2006. Since then, his work has focused in information technology and web development. He joined the Zooniverse team in the fall of 2012. He enjoys reading, running, and playing games of all sorts."
  ...
  guide:
    ...
    lensed_galaxies_text_4: "If you look at the examples below you will probably have already noticed that the lensed or distorted images tend to be blue/green rather than the yellow/red of the lensing galaxy. This is partly because more distant galaxies are more likely to be young and so they have a lot of young stars that predominantly create more energetic photons or blue light. In addition, distant galaxies are &quot;redshifted&quot; this means the light you actually see originated from a shorter or bluer wavelength. Hence distant galaxies tend to look blue or green. While this is typically true for most of the lenses you will see, if these objects are at very high redshift, it can be that the bright blue photons that are emitted are so far away that they actually arrive at earth at even longer wavelengths. These images will appear red in our colour composites. So don't reject red arcs or images - these could just be at high redshift! There's an example of a red arc in the tab Group Lenses and red/magenta lensed quasars in the tab Lensed Quasars."
    lensed_galaxies_text_5: "This faint blue/green galaxy is being magnified and distorted into an arc by the massive red galaxy. See how the arc curves around the lens. There is a hint of a counter-image (a second image opposite side of the lens to the primary arc). It is the same colour as the primary arc but it is typically fainter. Because of this, sometimes the counter image is bright enough to be seen (as in this case) but sometimes it is too faint to be seen."
    lensed_galaxies_text_6: "Here you see an example similar to the one above but in this case the arc is green, and the counter image cannot be clearly seen due to the noise in the image and the large extent of the lensing galaxy."
    ...
    double: "Doubles"
    quad: "Quads"
    quadandhighz: "Quads and High-redshift"
    high_z: "High-z"

    lensed_quasars_CFHTLS_text_1: "Quasars or quasi-stellar objects are very compact galaxies that have very bright central regions that outshine the rest of the galaxy making it look &quot;star-like&quot;. The nucleus is so bright because it is massive and it is made up of millions of stars with a very massive black hole. As matter falls into the black hole it lights up making the nucleus very bright. When a compact object like a quasar is lensed by a galaxy that's lying between us and the quasar it is lensed into discrete multiple images like the examples shown below. Quasars are rare compared to galaxies and hence, lensed quasars are even rarer than lensed galaxies. Below the examples show quasars lensed by a single galaxy, quasars lensed by a galaxy group are even rarer. To date, only three quasars lensed by a galaxy group/cluster have been found."
    lensed_quasars_CFHTLS_text_2: "This is a bright blue &quot;quasi-stellar object&quot; behind a massive galaxy: it has been lensed into two images, one on either side of the lens galaxy."
    lensed_quasars_CFHTLS_text_3: "This quasar has been lensed into four images, arranged around the galaxy. This is called the Einstein cross configuration. Quads are about 6 times rarer than doubles."
    lensed_quasars_CFHTLS_text_4: "This is a quasar at high redshift, so it appears yellow-ish. The image configuration in this case is a quad, with two of the quad images very close together."

    lensed_quasars_VICS82_text_1: "Quasars or quasi-stellar objects are very compact galaxies that have very bright central regions that outshine the rest of the galaxy making it look &quot;star-like&quot;. The nucleus is so bright because it is massive and it is made up of millions of stars with a very massive black hole. As matter falls into the black hole it lights up making the nucleus very bright. When a compact object like a quasar is lensed by a galaxy that's lying between us and the quasar it is lensed into discrete multiple images like the examples shown below. Quasars are rare compared to galaxies and hence, lensed quasars are even rarer than lensed galaxies. Below the examples show quasars lensed by a single galaxy, quasars lensed by a galaxy group are even rarer. To date, only three quasars lensed by a galaxy group/cluster have been found."
    lensed_quasars_VICS82_text_2: "This is a bright blue &quot;quasi-stellar object&quot; behind a massive galaxy: it has been lensed into two images, one on either side of the lens galaxy."
    lensed_quasars_VICS82_text_3: "As mentioned on the previous page, some of the images in the survey are a lower resolution. This is an example of what a lensed quasar, like the previous one with two images, would like in this lower resolution data."
    lensed_quasars_VICS82_text_4: "These are three examples of quasars that have been lensed into four images, arranged around the lensing galaxy.  Quads are about 6 times rarer than doubles! There are differences between these quads most obviously in colour and configuration."
    lensed_quasars_VICS82_text_5: "The configuration of the middle example is in a regular cross - this is called the Einstein cross configuration. The other quads have different configurations, this is due to the position of the source behind then lens, this cause the cross to change from being 4 equidistant images as in the middle example to more skewed configurations in the first and third quad example."
    lensed_quasars_VICS82_text_6: "The three quads also have different colours, blue, greenish-yellow and pink. This change in colour is a result of distance from us, the closest quasars will appear blue in our colour images, those that are further away (i.e.  that live in an earlier age of the Universe) will get redder going from green-yellow-orange-pink-red. Whether a quad or a pair of lensed quasars or a lensed galaxy, the higher the redshift of the lensed galaxy the more yellow-red it will appear."
    ...
    group_lenses_text_4: "Depending on the mass and configuration of the lensing group, these images can be small and rather than giant arcs"
    ...
    lonersandlightweights: "Loners &amp; Lightweights"
    loners: "Loners"
