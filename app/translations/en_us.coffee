module.exports =
  ...
  guide:
    ...
    lensed_quasars_text_3: "As mentioned on the previous page, some of the images in the survey are a lower resolution. This is an example of what a lensed quasar, like the previous one with two images, would like in this lower resolution data."
    quad: "Quad and High-redshift"
    lensed_quasars_text_4: "These are three examples of quasars that have been lensed into four images, arranged around the lensing galaxy.  Quads are about 6 times rarer than doubles! There are differences between these quads most obviously in colour and configuration."
    lensed_quasars_text_5: "The configuration of the middle example is in a regular cross - this is called the Einstein cross configuration. The other quads have different configurations, this is due to the position of the source behind then lens, this cause the cross to change from being 4 equidistant images as in the middle example to more skewed configurations in the first and third quad example."
    lensed_quasars_text_6: "The three quads also have different colours, blue, greenish-yellow and pink. This change in colour is a result of distance from us, the closest quasars will appear blue in our colour images, those that are further away (i.e.  that live in an earlier age of the Universe) will get redder going from green-yellow-orange-pink-red. Whether a quad or a pair of lensed quasars or a lensed galaxy, the higher the redshift of the lensed galaxy the more yellow-red it will appear."
