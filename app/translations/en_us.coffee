  ...
  feedback:
    ...
    false_positives:
      ...
      CFHTLS_stage2_fps:
        ...
        spirals_rings: "Spiral and ring galaxies often have yellow-red bulges that can mimic massive lens galaxies; their arms usually have the wrong shapes and positions to be lensed arcs though."
