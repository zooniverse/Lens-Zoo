module.exports =
  ...
  guide:
    ...
    mergers_neighbors_text_3: "Two galaxies merging together can look a bit like a lens system. Here two spiral galaxies appear to be merging, you can see two reddsih bulges with multiple arms visible and a fuzzy distribution of light. Sometimes mergers cause displaced arms, or tidal tails. Unlike arcs, the arms or tidal tails do not trace a circle around the red bulge."
    ...
    stars_text_2: "This field shows some compact objects that are stars. Some of the bright red and blue stars have been marked in the right image by red abd blue arrows, respectively. Sometimes blue background galaxies lie close to these red stars and give the impression that they are lenses. To determine if you are looking at a star or a galaxy a quick check is to look out for faint symmetric spikes emmanating from the compact sources (faint spikes are marked in grey). These spikes are caused by the structure in the telescope, and stars are so compact and bright that they can cause these spikes to be recorded on the detector. They are not inherent features of the star but just an artifact caused by the light of the star passing into the telescope. These features are called diffraction spikes."
    stars_text_3: "For extremely bright stars, these spikes become very pronounced. Such bright stars can actually overwhelm the detector and cause pixels some strange effects. In this case the detector pixels have recieved so much light that they have become saturated. Saturation causes very strange effects like the one seen above. A lot of the light from the bright star has spilled out into a large white halo and along the diffraction spikes. Further out from the star, multi-coloured rings or halos may also be seen. The rings are not related to lensing but due to effects generated by the optical elements of the telescope."
    ...
    stars_text_5: "Here's one of the CFHTLS images that we've marked up with stars and galaxies. It doesn't contain any gravitational lens candidates, but it hopefully gives you an idea of what different kinds of objects look like in the CFHT images."
