module.exports =
  ...
  tutorial:
    ...
    mark: 
      ...
      details_stage2: "If you see something that is being lensed, and you've checked the Spotter's Guide to make sure it's not a False Positive, mark it. In this case, click on the blue arc!"
    good_job:
      header: "Great job!"
